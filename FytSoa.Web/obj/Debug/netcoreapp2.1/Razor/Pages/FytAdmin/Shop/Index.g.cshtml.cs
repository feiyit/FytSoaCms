#pragma checksum "D:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Shop\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b83bbecff4740f53758d4468a8be15304b80842e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b83bbecff4740f53758d4468a8be15304b80842e", @"/Pages/FytAdmin/Shop/Index.cshtml")]
        ...
        layui.config({
                ...
                table.render({
                    ...
                    cols: [
                        [
                            { type: 'checkbox', fixed: 'left' },
                          ");
            WriteLiteral(@"  { field: 'methodName',width:100, title: '活动方式' },
            ...
            WriteLiteral(@"tle: '手机号码' },
                ...
                var shopGuid = '', active = {
                    ...
                    //点击店铺查询活动和店铺会员
         ");
            WriteLiteral(@"           reloadActAndUser: function () {
...
");
            WriteLiteral(@"                        os.Open('添加活动', '/fytadmin/shop/activitymodify?shop=all', '850px', '450px', function () {
         ...
         ");
            ...
            WriteLiteral(@"
                    ...
                    toolUserDel: function () {
                        ...
                        lay");
            WriteLiteral(@"er.confirm('确定要执行批量删除吗？', function (index) {
                            layer.close(index);
                            var loadindex = layer.load(1, {
                                shade: [0.1, '#000']
                            });
