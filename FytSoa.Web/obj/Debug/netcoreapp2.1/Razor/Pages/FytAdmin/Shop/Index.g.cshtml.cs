#pragma checksum "D:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Shop\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "35fec0ac655aa72764a30db90fe2005d720db0cf"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"35fec0ac655aa72764a30db90fe2005d720db0cf", @"/Pages/FytAdmin/Shop/Index.cshtml")]
    ...
    public class Pages_FytAdmin_Shop_Index : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#line 3 "D:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Shop\Index.cshtml"
...
#line hidden
  ...
  ");
            WriteLiteral(@"                          { type: 'checkbox', fixed: 'left' },
                            { field: 'shopName', title: '店铺名称', sort: true, fixed: 'left', event: 'gotool' },
                ...
                table.render({
                    ...
                    cols: [
                        [
                            { type: 'checkbox', fixed: 'left' },
 ");
            WriteLiteral(@"                           { field: 'trueName', title: '姓名', sort: true, fixed: 'left' },
            ...
            WriteLiteral(@"     } else {
                    ...
                    toolUserAdd: function () {
                        ...
                        os.Open('添加员工', '/fytadmin/shop/usermodify?shop=' + shopGuid, '600px', '450px', function () {
                            active.reloadActAndUser();
                        });
                    },
                    //删除会员
...
");
            ...
            WriteLiteral(@"        shade: [0.1, '#000']
                ...
                table.on('tool(tool)', function (obj) {
                    ...
                    if (obj.event === 'edit') {
       ");
            WriteLiteral(@"                 os.Open('编辑店铺', '/fytadmin/shop/shopmodify/?guid=' + data.guid, '850px', '500px', function () {
                            active.reload();
                        })
                    }
                    if (obj.event === 'gotool') {
                    ...
                    if (obj.event ==='staff') {
                        ...
                        layuiIndex = layer.open({
                            ...
                            , skin: 'layer-anim-07'
                            , ");
            WriteLiteral(@"content: ""/fytadmin/member/index/?shop="" + data.guid
                            , end: function () {
                ...
                table.on('tool(usertool)', function (obj) {
                    ...
                    if (obj.event === 'edit') {
        ");
            WriteLiteral(@"                os.Open('编辑会员', '/fytadmin/shop/usermodify/?guid=' + data.guid + ""&shop="" + shopGuid, '600px', '450px', function () {
                            active.reloadActAndUser();
                        })
                    }
                });
