#pragma checksum "D:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Sys\Role.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "83973fdfe914659dc65fa3536ec16fbf663e5945"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"83973fdfe914659dc65fa3536ec16fbf663e5945", @"/Pages/FytAdmin/Sys/Role.cshtml")]
    ...
    public class Pages_FytAdmin_Sys_Role : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#line 3 "D:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Sys\Role.cshtml"
...
#line hidden
    ...
    ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "d07c87b7c0bb42de8a613446720e5ac5", async() => {
            }
            );
        ...
        layui.config({
            ...
            WriteLiteral(@"e: true,
                ...
                var guid = '', typeName = '', active = {
                    ...
                    toolMenu: function () {
                        os.Open('角色分配功能模块', '/fytadmin/sys/rolemenu', '620px', '400px', function () {
                            os");
            WriteLiteral(@".success(""分配成功~"");
                        });
                    },
                    ...
                    organizeDel: function () {
                        ...
                        layer.confirm('");
            WriteLiteral(@"确定要执行批量删除吗？', function (index) {
                            layer.close(index);
    ...
    <script type=""text/html"" id=""tool"">
        <a class=""layui-btn ");
            WriteLiteral("layui-btn-primary layui-btn-xs\" lay-event=\"edit\"><i class=\"layui-icon\"></i> 修改</a>\r\n    </script>\r\n</div>\r\n");
            EndContext();
        }
