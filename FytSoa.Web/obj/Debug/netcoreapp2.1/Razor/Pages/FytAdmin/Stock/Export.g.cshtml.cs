#pragma checksum "E:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Stock\Export.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e1a91f15f65b7daa33fb403b3f440cf1f456bf1c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e1a91f15f65b7daa33fb403b3f440cf1f456bf1c", @"/Pages/FytAdmin/Stock/Export.cshtml")]
...
#line hidden
    ...
    <div class=""right-col-body"">
        <div class=""list-wall"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fe2b3cc1e34045e5b98b740bdc088b3b", async() => {
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "453af22f3dc542458951a6dbb5e3a145", async() => {
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "075be1f31bc14743af7e0db90c2964ea", async() => {
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b164f2ca715d407bbec4d26e1c250d2b", async() => {
...
#line hidden
    ...
    ");
            EndContext();
            BeginContext(5565, 73, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dc57869e7e3d4d86b1129e932f6d698a", async() => {
            }
            );
...
");
            WriteLiteral(@"                        $("".fyt-task-menu"").addClass('layui-hide');
                ...
                var packguid = '', shopGuid = '', active = {
                    ...
                    addIn: function () {
                        os.Open('新增出库单', '/fytadmin/stock/packlog/?type");
            WriteLiteral(@"s=2', '600px', '400px', function () {
                            funTool.packPage();
                        });
                    },
                    toolAdd: function () {
            ...
            WriteLiteral(@"860px', '600px', function () {
                    ...
                    toolDel: function () {
                        ...
                        layer.confirm('确定要执行批量删除吗？删除后平台库存会增加相应出库数量', function (index) {
                            ...
                            os.ajax('a");
            WriteLiteral(@"pi/stock/delinout/', { parm: str }, function (res) {
     ...
     ");
            ...
            WriteLiteral(@"           } else {
                ...
                table.on('tool(tool)', function (obj) {
                    var data = obj.data;
                    if (obj.event === 'edit') {
                        os.Open('修改出库信息', '/fytadmin/stock/exportmodify/?guid=' + data.guid, '600");
            WriteLiteral(@"px', '350px', function () {
                            active.reload();
                        });
                    }
                });
