#pragma checksum "E:\2018Project\ERP项目\SoaProJect\FytSoa.Web\Pages\FytAdmin\Stock\Import.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2b7ad0f838ed7dd8b28b57c16f0bb5a0c5fa8d05"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2b7ad0f838ed7dd8b28b57c16f0bb5a0c5fa8d05", @"/Pages/FytAdmin/Stock/Import.cshtml")]
...
#line hidden
    ...
    <div class=""right-col-body"">
        <div class=""list-wall"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e6cb3916d67649e4b817e64a9fc8cb2f", async() => {
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2f4fc38220f247e4b80641513099534b", async() => {
        ...
        layui.config({
            ...
            WriteLiteral(@"     elem: '#tablist',
                ...
                $(document).click(function (e) {
                    ...
                    if (_target.closest("".fy");
            WriteLiteral(@"t-task-menu"").length == 0) {
                ...
                var packguid='', active = {                    
                    ...
                    addIn: function () { 
                ");
            WriteLiteral(@"        os.Open('添加入库单', '/fytadmin/stock/packlog/?types=1', '600px', '400px', function () {
                            funTool.packPage();
                        });
                    },
                    toolAdd: function () {
            ...
            WriteLiteral(@"           $.each(data, function (i, item) {
                ...
                funTool = {
           ");
            WriteLiteral(@"         getGoodsSku: function (obj) {
                        packguid = obj.guid;
                        active.reload();
                    },
                    packPage: function () {
            ...
            WriteLiteral(@"-hide');
                    ...
                    tool: function (event) {
                        ...
                        var obj = ");
            WriteLiteral(@"$(event.target).offset();
