...
namespace FytSoa.Core
{
    ...
    public class DbContext
    {
        ...
        //ERP表信息
        public DbSet<ErpSkuLossOrder> ErpSkuLossOrderDb => new DbSet<ErpSkuLossOrder>(Db);
        ...
        public DbSet<ErpReturnLoss> ErpReturnLossDb => new DbSet<ErpReturnLoss>(Db);
        ...
        public DbSet<ErpUserPointLog> ErpUserPointLogDb => new DbSet<ErpUserPointLog>(Db);
